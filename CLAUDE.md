...
| 역할 | 변수명 | HEX | 용도 |
|---|---|---|---|
| Brand Neon Pink | `--color-brand` | `#FF6FB0` | 헤더, 로고, 주요 액션 버튼 |
...
| 역할 | 변수명 | HEX | 용도 |
|---|---|---|---|
| Background | `--color-bg` | `#FFF5F8` | 페이지 전체 배경 |
| Title | `--color-text-title` | `#3D2C35` | 제목, 강조 텍스트 |
| Body | `--color-text-body` | `#6E5A63` | 본문, 일반 텍스트 |
| Placeholder | `--color-text-muted` | `#B39AA3` | 플레이스홀더, 비활성 텍스트 |

#### Dark Mode

| 역할 | 변수명 | HEX | 용도 |
|---|---|---|---|
| Header | `--color-header-dark` | `#2A1420` | 다크모드 헤더 배경 |
| Background | `--color-bg-dark` | `#191113` | 다크모드 페이지 배경 |
| Title | `--color-text-title-dark` | `#F5E8ED` | 다크모드 제목 텍스트 |
| Body | `--color-text-body-dark` | `#C8B2BC` | 다크모드 본문 텍스트 |
| Placeholder | `--color-text-muted-dark` | `#7A5A67` | 다크모드 플레이스홀더 |
